...
function calc_participacao_social() {
    ...
    if (res_group != 0) {
        ...
        else if (res_group == 39) {
            score_group = 99;
            tscore_group = 78;
        }
        else if (res_group == 40) {
            score_group = 99;
            tscore_group = 80;
        }
...
function calc_audicao() {
    ...
    let indexquestion_start = 21;
    let indexquestion_end = 30;
...
function calc_toque() {
    ...
    let indexquestion_start = 31;
    let indexquestion_end = 40;
...
function calc_gosto_e_olfato() {
    ...
    let indexquestion_start = 41;
    let indexquestion_end = 45;
...
function calc_tscore_total() {
    ...
    console.log("p escola -> calc_tscore_total | tscore_total = " + tscore_total);
