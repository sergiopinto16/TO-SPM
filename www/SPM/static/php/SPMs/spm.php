...
class SPM{
    ...
    public function check_table_spms(){        
        ...
        $query = "CREATE TABLE IF NOT EXISTS spms (
            ...
            GROUP_PS_COMENTARIO varchar(255) NOT NULL,GROUP_VIS_COMENTARIO varchar(255) NOT NULL,GROUP_AUD_COMENTARIO varchar(255) NOT NULL,GROUP_TOQ_COMENTARIO varchar(255) NOT NULL,GROUP_GO_COMENTARIO varchar(255) NOT NULL,
            GROUP_CONSCCORP_COMENTARIO varchar(255) NOT NULL,GROUP_MOVEQU_COMENTARIO varchar(255) NOT NULL,GROUP_PLAMI_COMENTARIO varchar(255) NOT NULL,GROUP_TOTAL_COMENTARIO varchar(255) NOT NULL,
